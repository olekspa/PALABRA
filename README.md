...
- **Palabra Lines:** Color Lines / Lines 98 reborn for phones--guide glowing balls across a 9x9 grid, clear five-in-a-row combos, then ace a six-option Spanish translation quiz to keep the board alive.
...
6. **Number drill** - a 4x4 grid plays audio for numbers 1-100; match five prompts to earn bonus XP.
...
## Release & Deployment
- Application version is surfaced on the Gate screen and must be bumped in `lib/app/app_constants.dart` for every change (current: **7.433**).
...
- Version bump rule: increment the micro component (e.g., 7.432 -> 7.433) whenever the repository changes.
